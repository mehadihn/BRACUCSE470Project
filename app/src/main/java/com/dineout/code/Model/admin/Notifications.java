...
public class Notifications extends AppCompatActivity {
    ...
    ArrayList<com.dineout.code.Model.admin.NotificationClass> notifications;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notifications = new ArrayList<com.dineout.code.Model.admin.NotificationClass>();
        ...
        if (isNetworkAvaliable(this)) {
            databaseReference.addValueEventListener(new ValueEventListener() {
                com.dineout.code.Model.admin.NotificationClass notification;
    ...
    public void onBackPressed() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                    notification = dsp.getValue(com.dineout.code.Model.admin.NotificationClass.class);
                    if (notification != null) {
                        databaseReference.child(dsp.getKey()).child("read").setValue(true);
                    }
                }
                notificationsAdapter = new com.dineout.code.Model.admin.NotificationsAdapter(getBaseContext(), notifications);
                rvNotifications.setAdapter(notificationsAdapter);
