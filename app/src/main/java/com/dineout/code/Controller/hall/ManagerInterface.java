...
import com.dineout.code.Controller.admin.LoginActivity;
...
public class ManagerInterface extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View V) {
                Intent myIntent = new Intent(ManagerInterface.this,com.dineout.code.Controller.billing.PendingPayments.class);
                startActivity(myIntent);
            }
        });
